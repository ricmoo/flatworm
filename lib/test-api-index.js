...
import { API, ClassExport, ConstExport, PropertyExport, Export, FunctionExport, ObjectExport, TypeExport, TypeBasic, TypeFunction, TypeIdentifier, TypeGroup, TypeLiteral, TypeMapping, TypeTodo, TypeWrapped } from "./jsdocs.js";
...
;
function addHeader(config, output, section, links, _toc) {
...
function addFooter(output, previous, next, genDate) {
...
export function generate(api, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < mainToc.length; i++) {
            ...
            addFooter(output, previousEntry, nextEntry, getTimestamp(yield getGenDate(section.dependencies)));
