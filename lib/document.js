    ...
    evaluate(script) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.language === "javascript") {
                try {
                    let scriptName = path_1.join(this.page.filename, "script.js");
                    ...
                    __classPrivateFieldSet(this, _code, Object.freeze(yield script.run(scriptName, this.source)));
                }
                catch (error) {
...
class Page {
    ...
    static searchPage(basepath) {
        return new Page(path_1.resolve(basepath, "search"), [new Fragment(FragmentType.SECTION, "Search", [])]);
    }
    get toc() {
...
class Document {
    ...
    static fromFolder(path, config) {
        ...
        pages.push(Page.searchPage(path_1.resolve(path)));
        //        console.log("Processing Directroy:", resolve(path));
        return new Document(path_1.resolve(path), pages, config);
    }
}
