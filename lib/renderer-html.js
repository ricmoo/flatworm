...
import { CodeFragment, FragmentType, TableFragment, TableStyle, TocFragment } from "./document";
import { ElementNode, LinkNode, ListNode, PropertyNode, SymbolNode, TextNode } from "./markdown";
...
export class HtmlRenderer extends Renderer {
    ...
    renderDocument(document) {
        ...
        [
            ...
            let content = fs.readFileSync(resolve(__dirname, "../static", filename));
