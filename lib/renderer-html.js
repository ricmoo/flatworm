...
class HtmlRenderer extends renderer_1.Renderer {
    ...
    renderDocument(document) {
        ...
        [
            ...
            let content = fs_1.default.readFileSync((0, path_1.resolve)(__dirname, "../static", filename));
        ...
        if (document.config.logo) {
            files.push({
                ...
                content: fs_1.default.readFileSync((0, path_1.resolve)(document.basepath, document.config.logo))
            });
        }
        else {
            files.push({
                filename: (base + "logo.svg"),
                content: fs_1.default.readFileSync((0, path_1.resolve)(__dirname, "../static/logo.svg"))
            });
        }
        if (document.config.socialImage) {
            files.push({
                filename: (base + document.config.socialImage),
                content: fs_1.default.readFileSync((0, path_1.resolve)(document.basepath, document.config.socialImage))
            });
        }
