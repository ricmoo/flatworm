...
var _Export_examples, _Export_docs, _ReturnsExport_returns, _ReturnsExport_parent, _ClassExport_ctor, __ApiSection_anchor, __ApiSection_flatworm, __ApiSection_title, _ApiSection_path, _ApiSection_navTitle;
import fs from "fs";
...
export class ObjectExport extends Export {
    constructor(type, filename, lineno, name, docs, supers) {
        super(filename, lineno, name, docs);
        this.type = type;
        this.supers = supers;
...
export class ClassExport extends ObjectExport {
    constructor(filename, lineno, name, docs, supers, isAbstract) {
...
__ApiSection_anchor = new WeakMap(), __ApiSection_flatworm = new WeakMap(), __ApiSection_title = new WeakMap();
