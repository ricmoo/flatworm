...
var _document, _page, _fragment, _modifiedDate;
Object.defineProperty(exports, "__esModule", { value: true });
exports.parseMarkdown = exports.parseBlock = exports.expandMacro = exports.StylesInline = exports.StylesAll = exports.MarkdownStyle = exports.escapeText = exports.CellNode = exports.CellAlign = exports.PropertyNode = exports.ListNode = exports.LinkNode = exports.ElementNode = exports.ElementStyle = exports.SymbolNode = exports.SymbolNames = exports.MacroNode = exports.TextNode = exports.Node = void 0;
let NextId = 1;
class Node {
    constructor() {
        _document.set(this, void 0);
        _page.set(this, void 0);
        _fragment.set(this, void 0);
        this.id = NextId++;
    }
    _setDocument(document, page, fragment) {
        ...
        __classPrivateFieldSet(this, _fragment, fragment);
    }
    get document() {
        return __classPrivateFieldGet(this, _document);
    }
    get page() {
        return __classPrivateFieldGet(this, _page);
    }
    get fragment() {
        return __classPrivateFieldGet(this, _fragment);
    }
}
exports.Node = Node;
_document = new WeakMap(), _page = new WeakMap(), _fragment = new WeakMap();
...
class MacroNode extends TextNode {
    constructor(macro) {
        super(MacroNode.expandMacro(macro));
        _modifiedDate.set(this, void 0);
        this.now = new Date();
        this.macro = macro;
    }
    ...
    _setModifiedDate(date) {
        if (__classPrivateFieldGet(this, _modifiedDate)) {
            throw new Error("modifiedDate already set");
        }
        __classPrivateFieldSet(this, _modifiedDate, date);
    }
    get textContent() {
...
function expandMacro(macro, now) {
