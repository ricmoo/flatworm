...
import { CodeContent } from "./document.js";
...
export class SearchRenderer extends Renderer {
    ...
    */
    render() {
        ...
        const indices = {};
        const compound = {};
        let section = this.document.sections[0];
        let wordCount = 0;
        let link = "";
        let summary = { title: "", blocks: [] };
        const addWord = (word, tag) => {
...
//# sourceMappingURL=renderer-search.js.map